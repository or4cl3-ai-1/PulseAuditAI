    ...
    <div className="bg-slate-950 text-white overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 lg:pt-52 lg:pb-40">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-slate-400 font-medium max-w-3xl mx-auto leading-relaxed mb-14">
            Audit complex regulatory documents in seconds. Harness regulatory blueprints to identify hidden compliance risks in EU AI Act, SOC 2, HIPAA, and GDPR policies.
          </p>
      ...
      <section className="py-32 max-w-7xl mx-auto px-4">
        <div className="text-center mb-24 space-y-6">
          <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white">Enterprise Infrastructure Suite</h2>
          <p className="text-slate-400 max-w-2xl mx-auto text-xl font-medium">Designed for modern SaaS providers requiring robust compliance frameworks, cloud storage controls, and client-facing interfaces.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[
            {
              title: "Custom Blueprint Checklists",
              desc: "Deploy customized law rules, configure weighted multipliers, declare required evidence items, and auto-feed them directly to Gemini models.",
              icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"
            },
            {
              title: "Multi-Cloud Storage Sync",
              desc: "Integrate buckets from AWS S3, Google Cloud Storage, or Azure Blob Storage. Audit security files instantly with no manual file uploads.",
              icon: "M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"
            },
            {
              title: "Rigorous Tenant Isolation",
              desc: "Lock down stakeholders to an isolated client portal. Access controls enforce row-level database segregation using secure tenant UUID badges.",
              icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"
            },
            {
              title: "Incremental Audit Lineage",
              desc: "Maintain multi-variant tracking of policy reviews in history lists to record compliance evolution as gap remediations are finalized.",
              icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"
            },
            {
              title: "Interactive Remediation AI",
              desc: "Engage with an embedded AI legal assistant grounded in framework law to answer queries, draft fixes, and refine policy components.",
              icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
            },
            {
              title: "Broad Framework Covers",
              desc: "Optimized regulatory profiles and preloaded prompt context for EU AI Act compliance, SOC 2 Typ II controls, GDPR Article checks, and HIPAA.",
            ...
            <div key={i} className="group p-10 bg-slate-900/50 border border-slate-800 rounded-[2.5rem] hover:bg-slate-800/50 transition-all hover:-translate-y-2">
              <div className="w-14 h-14 bg-slate-850 text-indigo-400 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-lg border border-slate-800">
